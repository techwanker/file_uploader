...
//import com.javautil.instrumentation.EventTimer;
...
public class TransformerHelper {
	...
	// private EventTimer transformerInstantiationTimer;
	// private EventTimer sourceDocumentTimer;
	...
	public void setTransformer(File xslFile) throws TransformerConfigurationException {
		...
		// transformerInstantiationTimer = new EventTimer(
		...
		// transformerInstantiationTimer.stop();
		// if (logger.isDebugEnabled()) {
		// logger.debug(transformerInstantiationTimer.toString());
		// }
