...
public class ImmutableDate extends java.util.Date {
	 ...
	 */
	@SuppressWarnings("deprecation")
	public ImmutableDate(final int year, final int month, final int day, final int hour, final int minute,
			final int second) {
	 ...
	 */
	@SuppressWarnings("deprecation")
	public ImmutableDate(final int year, final int month, final int day, final Calendar cal) {
