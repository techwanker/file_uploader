...
class PropertyLineParser {
    ...
    /**
      ...
      Continuation line characters are treated specially in this calculation.  The logical line
      number could be significantly less than the physical line number.
     */
     ...
     * character is an ASCII <code>#</code> or <code>!</code> is a comment.
    ...
    PropertyLineParser(String text, int logicalLineNbr) throws
	    java.io.IOException {
	// local variables
	// last token lexed
	...
	//System.out.println("PropertyLineParser parsing: '" + text + "'");
	// construct tokenizer
	...
	//System.out.println("token: tokenType: " + tokenType + "'" + tokenWord + "'");
	switch (tokenType) {
	case '#':
	    lineType = COMMENT;
	    value = line;
	...
	case StreamTokenizer.TT_WORD:
	    ...
	    //System.out.println("PropertyLineParser: " + text + " "  + key + " " + value);
	    break;
	case StreamTokenizer.TT_EOF:
	    lineType = EMPTY;
	    break;
	default:
	    //System.out.println("default token type was " + tokenType);
	}
	//System.out.println("exiting PropertyLineParser");
    }
	...
	if (lineType != DEFINITION) {
	    throw new java.lang.IllegalStateException(
		    "This line does not contain a definition");
	}
	...
	if (lineType != DESCRIPTION) {
	    throw new java.lang.IllegalStateException(
		    "This line does not contain a description");
	}
	...
	if (lineType != PROPERTY_VALUE) {
	    throw new java.lang.IllegalStateException(
		    "This line does not contain a property value");
	}
