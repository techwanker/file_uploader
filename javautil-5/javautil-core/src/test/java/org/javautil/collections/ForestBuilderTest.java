...
public class ForestBuilderTest {
	...
	public void testBuildTree() {
		...
		Assert.assertEquals(0,
				root1.getChildren().get(2).getChildren().get(2).getChildren().get(0).getChildren().size());
		Assert.assertEquals(0,
				root1.getChildren().get(2).getChildren().get(2).getChildren().get(1).getChildren().size());
		Assert.assertEquals(0,
				root1.getChildren().get(2).getChildren().get(2).getChildren().get(2).getChildren().size());
	}
