...
public class Class1 {
	...
	public String toString() {
		return "Class1 [stringFieldWithSetter=" + stringFieldWithSetter + ", longNumberField=" + longNumberField
				+ ", longField=" + longField + ", integerField=" + integerField + ", privateIntegerField="
				+ privateIntegerField + ", intField=" + intField + ", shortNumber=" + shortNumber + ", shortField="
				+ shortField + ", byteNumber=" + byteNumber + ", byteField=" + byteField + "]";
	}
