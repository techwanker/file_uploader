...
public class CreateDatabaseObjects {
	...
	private final Logger logger = Logger.getLogger("com.dbexperts.sales.examples.CreateDatabaseOjects");
	...
	String createSalesPerson = "create table salesperson " + "( "
			+ "	salesperson_id number(9) not null, " + "	display_name   varchar2(40), "
	...
	public void dropObjects(Connection conn) throws SQLException {
	...
	public void createObjects(Connection conn) throws SQLException {
...
//		createObject(conn, createCustomerIndex2);
	...
	private void createObject(Connection conn, String sql) throws SQLException {
		Statement stmt = conn.createStatement();
		stmt.execute(sql);
		stmt.close();
	}

	private void dropObject(Connection conn, String sql) throws SQLException {
		Statement stmt = conn.createStatement();
		try {
			stmt.execute(sql);
