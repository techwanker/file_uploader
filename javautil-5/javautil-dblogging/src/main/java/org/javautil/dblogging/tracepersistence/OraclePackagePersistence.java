...
public class OraclePackagePersistence implements DbloggerPersistence {
    ...
    public long persistJob(String processName, String className, String moduleName, String statusMsg, String tracefileName, String schema,
    	...
    	String callSql = "begin "
    			...
    			"                   \n" + 
    			"                   p_tracefile_name => :p_tracefile_name);"
    			+ "end;";
    	
    	    
//        String callSql =
//                " begin \n" +
//                "    logger_persistence.persist_job_log ( \n" +
//                "    p_job_log_id     => :p_job_log_id, \n" +
//                "    p_process_name   => :p_process_name, \n" +
//                "    p_classname      => :p_classname, \n" +
//                "    p_module_name    => :p_module_name ,\n" +
...
//                "end;";
    ...
    //  persistJobStatement.setInt("p_trace_level", 12);
