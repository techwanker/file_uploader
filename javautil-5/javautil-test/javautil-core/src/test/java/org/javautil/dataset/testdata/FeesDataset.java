...
public class FeesDataset {
	...
	private static MatrixDataset fees = new MatrixDataset(deferredAdjudicationMeta) {
		{
			addRow(ListHelper.toList("TX", "DALLAS", new Integer(1), new Double(311), new Double(380)));
			addRow(ListHelper.toList("TX", "DALLAS", new Integer(2), new Double(321), null));
			addRow(ListHelper.toList("TX", "HOUSTON", new Integer(1), new Double(312), new Double(0)));
			addRow(ListHelper.toList("TX", "Southlake", new Integer(3), new Double(333), null));
