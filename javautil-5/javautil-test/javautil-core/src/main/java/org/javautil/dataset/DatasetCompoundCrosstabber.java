...
public class DatasetCompoundCrosstabber<T> {
	...
	private final TreeMap<Object[], Object[]> columnLabels = new TreeMap<Object[], Object[]>(new ArrayComparator());

	@SuppressWarnings("unchecked")
	/*
	 * todo consider a dataset rowid class
	 */
	private final TreeMap<Object[], CrosstabRow> rows = new TreeMap<Object[], CrosstabRow>(new ArrayComparator());
	...
	public ArrayList<List<Object>> getMatrixLists() {
		...
		final ArrayList<List<Object>> rows = new ArrayList<List<Object>>(matrix.length);
