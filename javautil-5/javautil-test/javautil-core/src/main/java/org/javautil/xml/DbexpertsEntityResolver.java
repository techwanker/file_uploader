...
public class DbexpertsEntityResolver implements EntityResolver {
	...
	private static Logger logger = Logger.getLogger(DbexpertsEntityResolver.class.getName());
	...
	public InputSource resolveEntity(final String publicId, final String systemId) throws IOException {
		...
		if (systemId.startsWith(dbexpertsPath)) {
			...
			try {
				...
				final String message = "can't read '" + f.getAbsolutePath() + "'" + newline + "resourcePath '"
						+ resourcePath + "'" + newline + "filePartialPath '" + filePartialPath + "'" + newline
						+ e.getMessage();
