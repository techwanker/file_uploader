...
public class DiskInfo {
	...
	public void process(final File f) throws IOException {
		...
		if (depth < 2) {
			logger.info("depth is " + depth + " " + f.getAbsolutePath() + " digestCount " + digestCount
					+ " milliseconds " + digestMillis);
		}
	}
	...
	/**
	 * @param generateDigest
	 *            the generateDigest to set
	 */
	...
	/**
	 * @param maxBytesToDigest
	 *            the maxBytesToDigest to set
	 */
