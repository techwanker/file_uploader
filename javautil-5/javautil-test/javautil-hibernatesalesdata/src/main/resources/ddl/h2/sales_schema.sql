/* 
  In Oracle a global temporary table persists, in h2 closing the connection
  makes it disappear.  Global means what?  Can non global temporary tables
  be used?
*/
...
create index customer_ak1 on customer(outside_salesperson_id);

create index customer_ak2 on customer(inside_salesperson_id);
