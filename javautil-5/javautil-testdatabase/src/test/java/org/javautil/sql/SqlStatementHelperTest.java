...
public class SqlStatementHelperTest {
	...
	void testSqlText(String original, String expectedNoComment, String expectedConverted) {
		...
		logger.info("actualConverted:   " + stripper.getConvertedBindStatement());
		assertEquals("noComment",expectedNoComment,stripper.getNoComments());
		assertEquals("converted",expectedConverted,stripper.getConvertedBindStatement());
	}
