...
// // before releasing a connection or the AbandonedConnectionTimeout
// ConnectionCallback timeout doesn't work
//
// import java.io.File;
...
// MaxLimit connections active. If ConnectionWaitTimeout is greater than zero
// (0), each connection request waits for the specified number of seconds, or
// until a connection is returned to the cache. If no connection is returned to
// the cache before the timeout elapses, the connection request returns null.
//
...
// public class OracleDataSourceWrapperWithCallback implements
// DataSourceWrapper, ODSWrapperInterface, DataSource, Named {
...
//
// private static final TreeMap<String, Boolean> cachePropertyType = new
...
//
// try {
// final OracleCallableStatement ocs = (OracleCallableStatement)
// getWrappedConnection().prepareCall(sql);
...
// /**
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getAbandonedConnectionTimeout()
// */
...
// }
//
// public WrappedOracleConnection getConnection(final String
// authenticationString) throws SQLException, AuthenticationException {
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getConnectionCacheName()
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getPropertiesText()
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getConnectionType()
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getInactivityTimeout()
// */
...
// }
// final Properties p = isCacheProperty ? ds.getConnectionCacheProperties() :
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getLowerThresholdLimit()
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getMaxStatementsLimit()
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getOracleDataSource()
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getPropertyCheckInterval()
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#getTimeToLiveTimeout()
// */
...
// * @see com.dbexperts.oracle.datasource.ODSWrapperInterface#getConnection()
// */
// private WrappedOracleConnection getWrappedConnection() throws SQLException,
...
//
// }
// final WrappedOracleConnection woc =
// WrappedOracleConnection.getInstance(oconn);
// if (callback != null) {
// final long now = System.nanoTime();
// final StackTraceElement[] stack = Thread.currentThread().getStackTrace();
// final ConnectionCacheEntry cce = new ConnectionCacheEntry(woc, this, 5000,
// stack);
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setAbandonedConnectionCallback(oracle.jdbc.pool.OracleConnectionCacheCallback)
// */
...
// }
//
// public void setAbandonedConnectionTimeout(final Integer
// abandonedConnectionTimeout) throws SQLException {
...
// }
//
// public void setAllowUnauthenticatedConnectionRequests(final Object lockKey,
// final boolean value) {
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setValidateConnection(boolean)
// */
//
// @SuppressWarnings("unchecked")
// public void setCallback(final String connectionCallbackClassname) throws
...
// } catch (final Exception e) {
// throw new DataSourceInstantiationException(e.getMessage() + " on class " +
// connectionCallbackClassname);
// }
//
// }
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setConnectionCacheName(java.lang.String)
// */
// public void setConnectionCacheName(final String connectionCacheName) throws
// SQLException {
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setConnectionCachingEnabled(boolean)
// */
// public void setConnectionCachingEnabled(final boolean
// connectionCachingEnabled) throws SQLException {
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setConnectionWaitTimeout(int)
// */
...
// }
//
// public void setInactivityTimeout(final Integer inactivityTimeout) throws
// SQLException {
...
// /**
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setInitialLimit(java.lang.Integer)
// */
...
// throw new IllegalArgumentException("lock is already set invalid key passed "
// + _lock + " expected " + lock);
// }
// lock = _lock;
// }
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setLoginTimeout(int)
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setAbandonedConnectionTimeout(int)
// */
//
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setLowerThresholdLimit(int)
// */
// public void setLowerThresholdLimit(final int lowerLimit) throws SQLException
// {
// if (lowerLimit < 0) {
// throw new IllegalArgumentException("lowerThresholdLimit must be >0 not: " +
// lowerLimit);
// }
// setProperty(LowerThresholdLimit, lowerLimit);
// }
//
// public void setLowerThresholdLimit(final Integer lowerLimit) throws
// SQLException {
// setProperty(LowerThresholdLimit, lowerLimit);
//
// }
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setMaxStatementsLimit(java.lang.Integer)
// */
// public void setMaxStatementsLimit(final Integer maxStatementsLimit) throws
// SQLException {
// if (maxStatementsLimit != null) {
// final int val = maxStatementsLimit.intValue();
// if (val < 1) {
// throw new IllegalArgumentException("maxStatementLimit must be >= 1 not: " +
// val);
// }
...
// /**
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setOds(oracle.jdbc.pool.OracleDataSource)
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setPassword(java.lang.String)
// */
...
// }
//
// private void setProperty(final String propertyName, final int value) throws
// SQLException {
...
// logger.debug("setting connectionCacheProperty " + propertyName + " to " +
// value);
// } else {
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setPropertyCheckInterval(int)
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setServerName(java.lang.String)
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setServiceName(java.lang.String)
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setUser(java.lang.String)
// */
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setValues(com.dbexperts.oracle.datasource.OracleDataSourceWrapperValuesSourceInterface)
// */
// public void setValues(final OracleDataSourceWrapperValuesSourceInterface
...
// *
// * @see
// com.dbexperts.oracle.datasource.ODSWrapperInterface#setValuesAndTest(com.dbexperts.oracle.datasource.OracleDataSourceWrapperValuesSourceInterface)
// */
// public void setValuesAndTest(final
// OracleDataSourceWrapperValuesSourceInterface values) throws SQLException {
// try {
// setValues(values);
//
// } catch (final SQLException sqe) {
...
// }
// if (lock == null) {
// throw new UnsupportedOperationException("not locked must be locked with call
// to setLock previously");
// }
// if (lock != key) {
