...
public class UserEnv {
	...
	/**
	 * Accessor set method for action. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for authenticatedIdentity. No validation provided in
	 * base method.
	 */
	...
	/**
	 * Accessor set method for authenticationData. No validation provided in
	 * base method.
	 */
	...
	/**
	 * Accessor set method for authenticationMethod. No validation provided in
	 * base method.
	 */
	...
	/**
	 * Accessor set method for bgJobId. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for clientIdentifier. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for clientInfo. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for currentEditionId. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for currentEditionName. No validation provided in
	 * base method.
	 */
	...
	/**
	 * Accessor set method for currentSchema. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for currentSchemaAid. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for dbDomain. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for dbName. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for dbUniqueName. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for fgJobId. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for globalContextMemory. No validation provided in
	 * base method.
	 */
	...
	/**
	 * Accessor set method for globalUid. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for host. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for identificationType. No validation provided in
	 * base method.
	 */
	...
	/**
	 * Accessor set method for instance. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for instanceName. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for ipAddress. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for isdba. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for lang. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for language. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for module. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for networkProtocol. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for nlsCalendar. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for nlsCurrency. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for nslDateFormat. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for nlsDateLanguage. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for nlsSort. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for nlsTerritory. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for osUser. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for serverHost. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for serviceName. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for sessionUser. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for sessionUserId. No validation provided in base
	 * method.
	 */
	...
	/**
	 * Accessor set method for sessionId. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for sid. No validation provided in base method.
	 */
	...
	/**
	 * Accessor set method for terminal. No validation provided in base method.
	 */
	...
	public String toString() {
		...
		String retValue = "UserEnv ( " + super.toString() + TAB + "action = "
				+ ((this.action == null) ? "null" : ("'" + this.action + "'")) + TAB + "authenticatedIdentity = "
				+ ((this.authenticatedIdentity == null) ? "null" : ("'" + this.authenticatedIdentity + "'")) + TAB
				+ "authenticationData = "
				+ ((this.authenticationData == null) ? "null" : ("'" + this.authenticationData + "'")) + TAB
				+ "authenticationMethod = '" + this.authenticationMethod + "'" + TAB + "bgJobId = "
				+ ((this.bgJobId == null) ? "null" : ("'" + this.bgJobId + "'")) + TAB + "clientIdentifier = "
				+ ((this.clientIdentifier == null) ? "null" : ("'" + this.clientIdentifier + "'")) + TAB
				+ "clientInfo = " + ((this.clientInfo == null) ? "null" : ("'" + this.clientInfo + "'")) + TAB
				+ "currentEditionId = "
				+ ((this.currentEditionId == null) ? "null" : ("'" + this.currentEditionId + "'")) + TAB
				+ "currentEditionName = "
				+ ((this.currentEditionName == null) ? "null" : ("'" + this.currentEditionName + "'")) + TAB
				+ "currentSchema = " + ((this.currentSchema == null) ? "null" : ("'" + this.currentSchema + "'")) + TAB
				+ "currentSchemaAid = "
				+ ((this.currentSchemaAid == null) ? "null" : ("'" + this.currentSchemaAid + "'")) + TAB + "dbDomain = "
				+ ((this.dbDomain == null) ? "null" : ("'" + this.dbDomain + "'")) + TAB + "dbName = "
				+ ((this.dbName == null) ? "null" : ("'" + this.dbName + "'")) + TAB + "dbUniqueName = "
				+ ((this.dbUniqueName == null) ? "null" : ("'" + this.dbUniqueName + "'")) + TAB + "fgJobId = "
				+ ((this.fgJobId == null) ? "null" : ("'" + this.fgJobId + "'")) + TAB + "globalContextMemory = "
				+ ((this.globalContextMemory == null) ? "null" : ("'" + this.globalContextMemory + "'")) + TAB
				+ "globalUid = " + ((this.globalUid == null) ? "null" : ("'" + this.globalUid + "'")) + TAB + "host = "
				+ ((this.host == null) ? "null" : ("'" + this.host + "'")) + TAB + "identificationType = "
				+ ((this.identificationType == null) ? "null" : ("'" + this.identificationType + "'")) + TAB
				+ "instance = " + ((this.instance == null) ? "null" : ("'" + this.instance + "'")) + TAB
				+ "instanceName = " + ((this.instanceName == null) ? "null" : ("'" + this.instanceName + "'")) + TAB
				+ "ipAddress = " + ((this.ipAddress == null) ? "null" : ("'" + this.ipAddress + "'")) + TAB + "isdba = "
				+ ((this.isdba == null) ? "null" : ("'" + this.isdba + "'")) + TAB + "lang = "
				+ ((this.lang == null) ? "null" : ("'" + this.lang + "'")) + TAB + "language = "
				+ ((this.language == null) ? "null" : ("'" + this.language + "'")) + TAB + "module = "
				+ ((this.module == null) ? "null" : ("'" + this.module + "'")) + TAB + "networkProtocol = "
				+ ((this.networkProtocol == null) ? "null" : ("'" + this.networkProtocol + "'")) + TAB
				+ "nlsCalendar = " + ((this.nlsCalendar == null) ? "null" : ("'" + this.nlsCalendar + "'")) + TAB
				+ "nlsCurrency = " + ((this.nlsCurrency == null) ? "null" : ("'" + this.nlsCurrency + "'")) + TAB
				+ "nlsDateLanguage = " + ((this.nlsDateLanguage == null) ? "null" : ("'" + this.nlsDateLanguage + "'"))
				+ TAB + "nlsSort = " + ((this.nlsSort == null) ? "null" : ("'" + this.nlsSort + "'")) + TAB
				...
				+ "osUser = " + ((this.osUser == null) ? "null" : ("'" + this.osUser + "'")) + TAB + "serverHost = "
				+ ((this.serverHost == null) ? "null" : ("'" + this.serverHost + "'")) + TAB + "serviceName = "
				+ ((this.serviceName == null) ? "null" : ("'" + this.serviceName + "'")) + TAB + "sessionId = "
				+ this.sessionId + TAB + "sessionUser = "
				+ ((this.sessionUser == null) ? "null" : ("'" + this.sessionUser + "'")) + TAB + "sessionUserId = "
				+ ((this.sessionUserId == null) ? "null" : ("'" + this.sessionUserId + "'")) + TAB + "sid = " + this.sid
				+ TAB + "terminal = " + ((this.terminal == null) ? "null" : ("'" + this.terminal + "'")) + TAB + " )";
