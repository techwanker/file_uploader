...
public class OracleConstraintsDAO {
	...
	public static List<OracleConstraint> getForTable(Connection conn, String owner, String tableName, boolean useDba,
	...
	public static void getRow(ResultSet rset, OracleConstraint row) throws java.sql.SQLException {
	...
	public static List<OracleConstraint> getImportedKeyConstraints(Collection<OracleConstraint> constraints,
