...
public class ColumnComments {
	...
	static final String columnText = "" + "    owner,\n" + "    table_name,\n" + "    column_name,\n"
			+ "    comments\n";
	...
	public static List<ColumnComment> getForTable(Connection conn, Table table) throws SQLException {
		...
		String selectText = "select " + columnText
				+ " from all_col_comments where owner = : owner and tableName = :tableName ";
	...
	public static void getRow(ResultSet rset, ColumnComment row) throws java.sql.SQLException {
