...
public class OracleTableConstraints {
	...
	// private Map<String,OracleConstraint> checkConstraintsByConstraintName =
	// new TreeMap<String,OracleConstraint>();
	// private Map<String,OracleConstraint> constraintsByConstraintName = new
	// TreeMap<String,OracleConstraint>();
	// private Map<Integer,OracleConstraint> checkConstraintsByColumnId = new
	// TreeMap<Integer,OracleConstraint>();
	// private Map<String,OracleConstraint> checkConstraintsByColumnName = new
	// TreeMap<String, OracleConstraint>();
	// private Map<String,OracleConstraint> importedForeignKeysByConstraintName
	// = new TreeMap<String, OracleConstraint>();
	...
	// public Map<String, OracleConstraint>
	// getCheckConstraintsByConstraintName() {
	...
	public List<OracleConstraint> getImportedForeignKeysByConstraintName() {
		...
		// todo should validate the constraints to ensure that they are unique
		// by name within owner but
		// if we are getting this from the database that is unnecessary, work on
		// this latter when populating
